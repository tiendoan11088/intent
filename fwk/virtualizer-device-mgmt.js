    ...
    return {
        ...
        postStepSynchronize: function (syncInput, result) {
                ...
                if ( networkState != "delete") {
                    apUtils.updateLabels(deviceName,intentConfigJson['label'],intentConstants.LABEL_MODE_EXECUTE);
                }
...
VirtualizerDeviceManager.prototype.postSynchronize = function (postExecuteCallBack, deviceName,iHubDeviceName) {
    ...
    return function (syncInput, networkState, result) {
        ...
        if ( neverSynced == false ) {
            if (networkState != "delete" && intentConfigJson['label'] != null ) {
                apUtils.updateLabels(deviceName, intentConfigJson['label'],intentConstants.LABEL_MODE_EXECUTE);
                apUtils.updateLabels(iHubDeviceName, intentConfigJson['label'],intentConstants.LABEL_MODE_EXECUTE);
            } else if ( lastIntentConfigFromTopo ) {
...
VirtualizerDeviceManager.prototype.createIntentConfigForSingleDevice = function (deviceInfo, input, configObject, isUplinkEthBoard) {
    ...
    if (deviceType.startsWith(intentConstants.LS_MF_PREFIX) && isClockMgmtSupportedForNT) {
    ...
    if ((deviceType.startsWith(intentConstants.LS_FX_PREFIX) && isClockMgmtSupportedForLT) || (deviceType.startsWith(intentConstants.LS_MF_PREFIX) && isClockMgmtSupportedForLT)
